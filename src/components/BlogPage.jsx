    ...
    posts: [
      {
        ...
        description:
          "Discover our architectural approach using Docker, Kubernetes, and message queues.",
        image: "/micro.webp",
        author: "Tech Team",
        date: "July 10, 2025",
      },
      {
        ...
        description:
          "From lazy loading to memoization – speed up your apps the right way.",
        image: "/react1.webp",
      ...
      },
      {
        ...
        description:
          "JWT, RBAC, CORS — everything you need to lock down your APIs.",
    ...
    posts: [
      {
        ...
        description:
          "We believe in innovation, inclusion, and integrity in everything we do.",
        image: "/culture.webp",
        author: "HR Team",
        date: "July 21, 2025",
      },
      {
        ...
        description:
          "Explore our evolution as a technology powerhouse since inception.",
        image: "/startup.webp",
      ...
      },
      {
        ...
        description:
          "From a 3-person garage team to a 50+ member powerhouse — here's our story of passion, growth, and gratitude.",
    ...
    posts: [
      {
        ...
        description:
          "A head-to-head comparison of frontend giants with real use cases.",
        image: "/a vs r.webp",
        author: "Dev Insights",
        date: "July 24, 2025",
      },
      {
        ...
        description:
          "DevOps = Faster Delivery + Reliability. Here's how we do it at Aadhaya.",
        image: "/devoops.webp",
        author: "DevOps Team",
        date: "July 25, 2025",
      },
      {
        ...
        description:
          "Learn how to efficiently manage code, collaborate in teams, and contribute to open source using Git and GitHub.",
        image: "/git.webp",
    ...
    posts: [
      {
        ...
        description:
          "Game-changing tech that helps ambulances reach faster using IoT.",
        image: "/iot.webp",
        author: "IoT Division",
        date: "July 27, 2025",
      },
      {
        ...
        description:
          "Explore open positions and work on innovative projects with us.",
        image: "/team.webp",
        author: "Talent Team",
        date: "July 29, 2025",
      },
      {
        ...
        description:
          "Our latest facility aims to accelerate AI, IoT, and Cloud-native R&D for next-gen tech solutions.",
        image: "/lab.webp",
    ...
    <div className="bg-gray-50 min-h-screen px-4 md:px-10 py-12">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-lg max-w-xl mx-auto" style={{ color: "#320A6B" }}>
          Explore our technical insights, innovations, culture, and latest
          company updates.
        </p>
      </div>
              ...
              {filtered.map((post) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-sm" style={{ color: "#320A6B" }}>
                      {post.description}
                    </p>
      ...
      {/* CTA */}
      <div
        className="text-white text-center py-12 rounded-lg mt-20"
      ...
      >
        ...
        <p className="mb-5 text-lg">
          Partner with Aadhaya for innovative, reliable software solutions.
        </p>
        <Link
          to="/contact"
